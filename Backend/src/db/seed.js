...
const DEFAULT_PAYMENT_METHODS = [
    ...
    { name: "Online Payments", code: "online_payments", methodType: "online", reducesCash: true, isCashTaken: false, sortOrder: 4 },
    { name: "Other", code: "other", methodType: "other", reducesCash: true, isCashTaken: false, sortOrder: 5 },
];
...
export async function seedDefaults() {
    ...
    if ((await PaymentMethodModel.countDocuments()) === 0) {
        await PaymentMethodModel.insertMany(DEFAULT_PAYMENT_METHODS);
    }
